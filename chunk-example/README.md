...
/******/
/******/
/******/ 	// run deferred modules from other async
...
// some module
__webpack_require__.e(/*! import() */ 2).then(__webpack_require__.t.bind(null, /*! ./chunk1 */ 1, 7));
__webpack_require__.e(/*! import() */ 3).then(__webpack_require__.t.bind(null, /*! ./chunk2 */ 2, 7));
...
chunk    {2} 2.[chunkhash].js 28 bytes <{0}> <{1}> [rendered]
    > ./chunk1 [0] ./example.js 2:0-18
 [1] ./chunk1.js 28 bytes {2} [built]
     import() ./chunk1 [0] ./example.js 2:0-18
chunk    {3} 3.[chunkhash].js 28 bytes <{0}> <{1}> [rendered]
    > ./chunk2 [0] ./example.js 3:0-18
 [2] ./chunk2.js 28 bytes {3} [built]
     import() ./chunk2 [0] ./example.js 3:0-18
```
